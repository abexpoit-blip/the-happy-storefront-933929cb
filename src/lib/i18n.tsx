...
const DICT: Record<string, string> = {
  ...
  "Быстрые подтверждения и минимальная комиссия сети. Другие монеты не принимаются.": "Fast confirmations and minimal network fees. Other coins are not accepted.",
  "Пополнить через LTC": "Recharge with LTC",
  "Пополните счёт на $": "Top up your balance by $",
  ", чтобы открыть магазин.": " to unlock the shop.",
  "Минимальная сумма пополнения — $$": "Minimum recharge amount — $",
  "Минимум $": "Minimum $",
  "(комиссия 2%)": "(2% fee)",
  "к оплате $": "to pay $",
  "Всего пополнений": "Total recharges",
  "Ждут пополнения": "Awaiting payment",
  "Основной баланс": "Main balance",
  "Бонусный баланс": "Bonus balance",
  "Бонусный баланс (рефералы)": "Bonus balance (referrals)",
  "Списывается первым при покупке": "Spent first on purchases",
  "После нажатия появится QR-код и адрес. Таймер — 30 минут.": "After clicking you get a QR code and address. Timer — 30 minutes.",
  "Статус проверяется автоматически каждые 10 секунд — не закрывайте вкладку.": "Status is checked automatically every 10 seconds — keep this tab open.",
  "Создайте счёт, оплатите на указанный адрес — баланс зачисляется автоматически после": "Create an invoice, pay to the given address — the balance is credited automatically after",
  "подтверждения сети. Средства сразу доступны для покупки карт.": "network confirmations. Funds are instantly available for buying cards.",
  "/2 подтверждений": "/2 confirmations",
  ", затем заявка истекает.": ", then the request expires.",
  "Заявка истекла — оплата по этому адресу больше не засчитывается. Создайте новую заявку.": "The request expired — payments to this address are no longer credited. Create a new request.",
  "зачислено на баланс!": "credited to your balance!",
  "Не удалось скопировать": "Copy failed",

  // referrals page
  "Реферальная программа | Zoru Shop": "Referral program | Zoru Shop",
  "Партнёрская программа": "Affiliate program",
  "Приглашай друзей — получай": "Invite friends — earn",
  "Приглашайте друзей в Zoru Shop и получайте бонус на баланс после их первого пополнения.": "Invite friends to Zoru Shop and earn a balance bonus after their first deposit.",
  "Как это работает": "How it works",
  "Ссылка для приглашения": "Invite link",
  "Ваш код": "Your code",
  "Приглашено (оплатили)": "Invited (paid)",
  "Заработано": "Earned",
  "Скопируйте свою ссылку или код выше.": "Copy your link or code above.",
  "Друг регистрируется по ссылке (код подставляется автоматически).": "Your friend signs up through the link (the code is filled in automatically).",
  "Друг делает": "Your friend makes a",
  "первое пополнение": "first deposit",
  "Вы и друг сразу получаете по": "You and your friend each instantly receive",
  "бонусный баланс": "bonus balance",
  "бонусный баланс. Выплата —": "bonus balance. Payout —",
  "один раз": "once",
  "на количество друзей.": "per number of friends.",
  "Бонус выплачивается": "The bonus is paid",
  "Бонусные деньги отображаются отдельно от основного баланса.": "Bonus money is shown separately from your main balance.",
  "Вывод бонусов недоступен, только покупки.": "Bonuses cannot be withdrawn, only spent on purchases.",
  "можно покупать карты": "can be used to buy cards",
  "Ими": "They",
  "Отправьте свою ссылку. Как только приглашённый": "Share your link. As soon as the invited user",
  "впервые пополнит баланс": "makes their first deposit",
  "вы получаете": "you receive",
  "и он тоже получает": "and they also receive",
  "за каждого": "for each",
  "за каждого приглашённого, без лимита": "per invited user, no limit",
  "за каждого приглашённого.": "per invited user.",
  "Проверка refund-карты стоит": "Checking a refundable card costs",
  "за карту (сверх цены карты).": "per card (on top of the card price).",
  "— платёж должен быть подтверждён.": "— the payment must be confirmed.",
  "— при покупке бонус списывается первым.": "— on purchase the bonus is spent first.",

              ...
              <tr key={c.id} className="border-b border-[#eef1f4] odd:bg-white even:bg-[#fafbfc] hover:bg-[#f2f8ff] transition">
                ...
                <td className="px-2.5 py-2 align-middle max-w-[240px]">
                  <span
                    ...
                    className="inline-block max-w-full truncate rounded-lg border border-[#a5d6a7] bg-gradient-to-b from-[#f1fbf2] to-[#dff3e2] px-2 py-1 text-[11.5px] font-semibold text-[#1b5e20] shadow-[inset_0_1px_0_rgba(255,255,255,0.9),0_3px_8px_-6px_rgba(27,94,32,0.8)]"
                  >
                    {publicBase(c.base) || "—"}
                  </span>
                </td>
                <td className="px-2.5 py-2 align-middle">
                  <span className="inline-block rounded-lg bg-gradient-to-b from-[#455a64] to-[#1f2d3d] px-2 py-1 font-mono text-[11.5px] font-bold tracking-wide text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.18),0_5px_12px_-7px_rgba(31,45,61,1)]">
                    {c.bin ?? "—"}
                  </span>
                  {c.last_digits ? (
                    <span className="ml-1.5 font-mono text-[11.5px] font-semibold text-[#78909c]">••{c.last_digits}</span>
                  ) : null}
                </td>
                <td className="px-2.5 py-2 align-middle">
                ...
                <td className="px-2.5 py-2 align-middle">
                  <CheckCircle2 className="h-4 w-4 text-[#2e7d32] drop-shadow-[0_2px_4px_rgba(46,125,50,0.45)]" />
                </td>
                <td className="px-2.5 py-2 align-middle whitespace-nowrap">
                  {c.country ? (
                    <span className="inline-flex items-center gap-2">
                      <CountryFlagImg code={c.country} className="h-5 w-7" />
                ...
                <td className="px-2.5 py-2 align-middle max-w-[200px]">
                  {c.city || c.state ? (
                    <span
                      ...
                      className="inline-block max-w-full truncate rounded-lg border border-[#ffd280] bg-gradient-to-b from-[#fffaf0] to-[#ffeec9] px-2 py-1 text-[11.5px] font-semibold uppercase text-[#8d6e00] shadow-[inset_0_1px_0_rgba(255,255,255,0.9)]"
                    >
                      {[c.city, c.state].filter(Boolean).join(", ")}
                    </span>
                  ) : <span className="text-[#bbb]">—</span>}
                </td>
                <td className="px-2.5 py-2 align-middle min-w-[160px]">
                ...
                <td className="px-2.5 py-2 align-middle font-mono text-[12.5px] font-semibold text-[#c62828]">{c.zip ?? "N/A"}</td>
                <td className="px-2.5 py-2 align-middle">
                  <span className={`inline-block rounded-full px-2.5 py-0.5 text-[11px] font-bold uppercase tracking-wide shadow-[inset_0_1px_0_rgba(255,255,255,0.85)] ${
                    c.refundable
                ...
                <td className="px-2.5 py-2 align-middle font-mono text-[14px] font-extrabold text-[#1f2d3d] whitespace-nowrap">

...
INSERT INTO public.site_settings (key, value) VALUES ('self_check_price', '0.20')
ON CONFLICT (key) DO NOTHING;
INSERT INTO public.site_settings (key, value) VALUES ('self_check_gate', 'CCV_Braintree_Auth')
ON CONFLICT (key) DO NOTHING;
...
REVOKE ALL ON FUNCTION public.charge_self_check(integer) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.charge_self_check(integer) FROM anon;
